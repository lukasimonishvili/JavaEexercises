...
public class SaltyRecipe extends Recipe{
    public SaltyRecipe(String name, Ingredient[] ingredients, String[] steps, String type) {
        super(name, ingredients, steps, type);
    }

    public void logDescription() {
        System.out.println("this is step by step guide how to prepare this salty recipe");
